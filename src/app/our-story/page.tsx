                            ...
                            <div className="space-y-6 mt-8 text-gray-800">
                                <div className="space-y-5 pl-6">
                                    <p className="text-lg leading-relaxed text-gray-600 font-roboto tracking-wider pt-2">
                                        ...
                                        control and protect industrial plants across the country. As experts in
                                        the field of safe power distribution, we serve as a reliable partner to
                                        industry, plant construction and power suppliers.  </p>

                                    <p className="text-lg leading-relaxed text-gray-600 font-roboto tracking-wider pt-2">
                                        Our product and services range from state-of-the-art low voltage
                                        electric panels process automation, control systems and services,
                                        right through to integrated electro technical solutions. We provide our
                                        technical and process-based knowhow to ensure the comprehensive
                                        and efficient management of complex electro technical solutions.  </p>

                                    <p className="text-lg leading-relaxed text-gray-600 font-roboto tracking-wider pt-2">
                                        Service tradition
                                        A to Zee has been offering its customers innovative technologies and
                                        services under one roof for 25 years. We are proud of our local
                                        tradition and combine it with a long-term global strategy.  </p>
