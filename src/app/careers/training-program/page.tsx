      ...
      <div className={dmSans.className}>
        <div className="px-4 py-12 md:py-20 pl-10">
          <div className="text-left">
            <p className="text-2xl md:text-3xl font-bold tracking-wide text-black mb-6 md:mb-8 leading-tight">
            ...
            <p className="text-gray-700 mb-8 md:mb-10 leading-relaxed font-normal text-base md:text-lg tracking-wider">
              Gain hands-on experience with Pakistan&apos;s leading electrical solutions provider. Our intensive 12-month program combines practical workshops, on-the-job training, and mentorship from senior engineers across all aspects of switchgear production and installation.
            </p>

            <p className="text-gray-700 mb-8 md:mb-10 leading-relaxed font-normal text-base md:text-lg tracking-wider">
              Develop specialized skills in power distribution systems while working on real client projects. Successful trainees receive industry certifications and priority consideration for full-time engineering positions within our growing organization.
            </p>
